...
--
-- Client :  localhost
-- Généré le :  Lun 08 Janvier 2018 à 01:09
...
(1, 'Entrées', 'De bonnes entrées', 'entree.png'),
(2, 'Plats', 'De bon plats', 'plat.png'),
(3, 'Desserts', 'De bon desserts', 'dessert.png');
...
('Pâtes', 'De bonnes pâtes fraiches aux oeufs', NULL, 0, 2);
...
(5, 'ClemDecoop', 'clement.decoopman@etu.univ-amu.fr', 'Decoopman', 'Clément', '$ClementDecoopman', 1, NULL);
...
--
ALTER TABLE `t_utilisateur_uti`
  MODIFY `UTI_ID` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
